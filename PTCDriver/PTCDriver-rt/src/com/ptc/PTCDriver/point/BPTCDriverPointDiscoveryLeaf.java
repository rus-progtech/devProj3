...
/**
 * BPTCDriverPointDiscoveryLeaf is container class for point elements to display in
...
public class BPTCDriverPointDiscoveryLeaf
  extends BNPointDiscoveryLeaf
{
//region /*+ ------------ BEGIN BAJA AUTO GENERATED CODE ------------ +*/
//@formatter:off
/*@ $com.ptc.PTCDriver.point.BPTCDriverPointDiscoveryLeaf(1643154273)1.0$ @*/
/* Generated Tue Jun 25 17:22:59 ICT 2024 by Slot-o-Matic (c) Tridium, Inc. 2012-2024 */
  ...
  public static final Type TYPE = Sys.loadType(BPTCDriverPointDiscoveryLeaf.class);

  //endregion Type

//@formatter:on
//endregion /*+ ------------ END BAJA AUTO GENERATED CODE -------------- +*/
  public BPTCDriverPointDiscoveryLeaf()
  {
  }
...
//    }
  ...
  public void updateTarget(BComponent target)
  {
    ...
    BPTCDriverProxyExt pext = new BPTCDriverProxyExt();
  ...
  public boolean isExisting(BComponent target)
  {
    ...
    BControlPoint cp = (BControlPoint) target;
    BPTCDriverProxyExt pext = (BPTCDriverProxyExt) cp.getProxyExt();
    //
